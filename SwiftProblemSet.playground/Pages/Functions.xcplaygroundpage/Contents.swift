...
emojiLove(stringParameterOne: "udacity", stringParameterTwo: "students")
emojiLove(stringParameterOne: "peanut butter", stringParameterTwo: "jelly")
emojiLove(stringParameterOne: "yin", stringParameterTwo: "yang")
//: ### Exercise 15
 ...
 */
func beginsWithVowel( _ stringValue: String) -> Bool {
    /* add function implementation here */
    
    var valueWithVowel = stringValue.uppercased()
    
    if stringValue == "" {
        return false
    } else {
        
        if (valueWithVowel.characters[valueWithVowel.startIndex] == "A") || (valueWithVowel.characters[valueWithVowel.startIndex] == "E") || (valueWithVowel.characters[valueWithVowel.startIndex] == "I")  || (valueWithVowel.characters[valueWithVowel.startIndex] == "O")  || (valueWithVowel.characters[valueWithVowel.startIndex] == "U") {
            return true
        } else {
            return false
        }
